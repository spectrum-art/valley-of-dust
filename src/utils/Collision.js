...
export default class Collision {
    // will be set by BootScene
    static game = null;
  
    static checkSpriteCollision(a, b) {
      // AABB overlap check
      const ax0 = a.position.x - a.scale.x/2;
      const ay0 = a.position.y - a.scale.y/2;
      const ax1 = a.position.x + a.scale.x/2;
      const ay1 = a.position.y + a.scale.y/2;
      const bx0 = b.position.x - b.scale.x/2;
      const by0 = b.position.y - b.scale.y/2;
      const bx1 = b.position.x + b.scale.x/2;
      const by1 = b.position.y + b.scale.y/2;
      ...
      // sample each sprite’s alpha at that point
      const sampleAlpha = sprite => {
      ...
      return sampleAlpha(a) > 128 && sampleAlpha(b) > 128;
    }
  }
